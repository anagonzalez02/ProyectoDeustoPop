...
public class DeustoPopVentanaVender extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
    	DeustoPopVentanaVender V = new DeustoPopVentanaVender();      // creamos una ventana
